...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '成长值变化历史记录' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_integration_change_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '积分变化历史记录' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of ums_member
-- ----------------------------
INSERT INTO `ums_member` VALUES (5, 2, 'zhangyoufa', '$2a$10$TLSSzasZH80uhOlNialgYOd08VCCApSivHL2y6zh7ciqcbIRQla9W', 'ambition', '19950374946', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (6, 2, 'zhangbobo', '$2a$10$WcVyvUKCcQp6jNgJZ2PkBuJTSswlN/L4YLbUQ2pyICVrRsonDOA/.', NULL, '13890015876', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `ums_member_collect_spu`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT 'create_time',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员收藏的商品' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_member_collect_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员收藏的专题活动' ROW_FORMAT = Compact;
...
CREATE TABLE `ums_member_level`  (
  ...
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员等级' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of ums_member_level
-- ----------------------------
INSERT INTO `ums_member_level` VALUES (2, '普通会员', 0, 1, 299.0000, 10, 0, 0, 1, '普通会员');
INSERT INTO `ums_member_level` VALUES (3, '铜牌会员', 2000, 0, 200.0000, 10, 0, 1, 1, '铜牌');
INSERT INTO `ums_member_level` VALUES (4, '银牌会员', 5000, 0, 229.0000, 20, 0, 1, 1, '银牌会员');
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员收货地址' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of ums_member_receive_address
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 5, 'zhangyoufa', '19989898989', NULL, '四川', '成都', '龙泉驿区', '成都市龙泉驿区', NULL, 1);
INSERT INTO `ums_member_receive_address` VALUES (2, 5, 'zhangyoufa', '19989898989', NULL, '四川', '达州', '万源市', '万源市太平镇', NULL, 0);
