...
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of oms_order
-- ----------------------------
INSERT INTO `oms_order` VALUES (39, 5, '202104012016585161377595844672483329', NULL, NULL, NULL, 8998.0000, 9007.0000, 9.0000, 0.0000, 0.0000, 0.0000, NULL, NULL, NULL, 1, NULL, NULL, 7, 0, 0, NULL, NULL, NULL, NULL, NULL, 'zhangyoufa', '19989898989', NULL, '四川', '达州', '万源市', '万源市太平镇', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2021-04-01 20:16:59');
...
CREATE TABLE `oms_order_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单项信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of oms_order_item
-- ----------------------------
INSERT INTO `oms_order_item` VALUES (69, NULL, '202104012016585161377595844672483329', 29, 'Apple iPhone XR (A2108) ', NULL, '24', 225, 38, 'Apple iPhone XR (A2108)  白色 128G  移动联通电信4G手机 双卡双待', 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', 4499.0000, 2, '颜色：白色;版本：128G', 0.0000, 0.0000, 0.0000, 8998.0000, 8998, 8998);
...
CREATE TABLE `oms_order_operate_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单操作历史记录' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order_return_apply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单退货申请' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order_return_reason`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT 'create_time',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退货原因' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order_setting`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单配置信息' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_payment_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `oder_sn`(`order_sn`) USING BTREE,
  UNIQUE INDEX `alipay_trade_no`(`alipay_trade_no`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of oms_payment_info
-- ----------------------------
INSERT INTO `oms_payment_info` VALUES (1, '202104012016585161377595844672483329', NULL, '2021040122001439720501663093', NULL, NULL, 'TRADE_SUCCESS', NULL, NULL, NULL, '2021-04-01 20:17:17');
...
CREATE TABLE `oms_refund_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退款信息' ROW_FORMAT = Compact;
