...
CREATE TABLE `pms_attr`  (
  ...
  `catelog_id` bigint(20) NULL DEFAULT NULL COMMENT '值类型【0单个值，1多个值】',
  `show_desc` tinyint(4) NULL DEFAULT NULL COMMENT '快速展示【是否展示在介绍上；0-否 1-是】，在sku中仍然可以调整',
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (15, '内存', 0, '1', '4G;6G', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (35, '颜色', 0, '1', '', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (36, '版本', 0, '1', '', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (38, 'CPU品牌', 1, '1', '海思（Hisilicon）;以官网信息为准', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (39, 'CPU型号', 1, '1', 'A13;麒麟990', 1, 1, 225, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (18, 17, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (19, 18, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (20, 19, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (21, 20, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (22, 21, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (23, 22, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (24, 23, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (25, 24, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (26, 25, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (27, 26, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (28, 27, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (29, 28, 20, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (30, 29, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (31, 30, 22, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (32, 31, 22, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (33, 32, 23, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (34, 33, 23, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (35, 34, 23, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (36, 37, 21, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (37, 38, 22, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (38, 39, 22, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性分组' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (20, '主体', 1, '主体属性', '1', 225);
INSERT INTO `pms_attr_group` VALUES (21, '基本信息', 1, '基本信息', '1', 225);
INSERT INTO `pms_attr_group` VALUES (22, '主芯片', 1, '主芯片', '1', 225);
INSERT INTO `pms_attr_group` VALUES (23, '屏幕', 1, '屏幕', '1', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (22, '华为', 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-03/4a962874-ef70-427a-811b-a40df9db43ef_huawei.png', '华为手机', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (23, '小米', 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-03/874ba227-50ea-490e-8f22-e431cfb27cf6_xiaomi.png', '小米手机', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (24, 'Apple', 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-07/eb6c5570-d9f1-41da-8c81-f93e246aa99b_apple.png', '苹果', 1, 'P', 1);
INSERT INTO `pms_brand` VALUES (25, 'oppo', 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-03/e7b2f82d-6db8-499e-8b16-ab5722eeb55d_oppo.png', 'oppo', 1, 'o', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1433 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_category
-- ----------------------------
INSERT INTO `pms_category` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 0, '22', NULL, 0);
...
INSERT INTO `pms_category` VALUES (165, '电子书1111', 22, 3, 1, 0, NULL, NULL, 0);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (14, 23, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (18, 22, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (21, 24, 225, 'Apple', '手机');
...
CREATE TABLE `pms_comment_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价回复关系' ROW_FORMAT = Compact;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 236 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (232, 28, 38, 'CPU品牌', '海思（Hisilicon）', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (233, 28, 39, 'CPU型号', '麒麟990', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (234, 29, 38, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (235, 29, 39, 'CPU型号', 'A13', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku图片' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (89, 32, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (90, 32, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/37cfc459-414b-49eb-884f-52e917eaa9b6_a83bf5250e14caf2.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (91, 32, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/e39bbc12-385f-48ff-8d0a-7a2b6fea831f_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (92, 33, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (93, 33, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/37cfc459-414b-49eb-884f-52e917eaa9b6_a83bf5250e14caf2.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (94, 33, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/e39bbc12-385f-48ff-8d0a-7a2b6fea831f_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (95, 34, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (96, 34, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0ef4cf36-5e97-4c65-8b45-48d79f8487c3_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (97, 34, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/bb35dc9c-d0fc-47a4-8d06-d18422d7f574_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (98, 35, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (99, 35, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0ef4cf36-5e97-4c65-8b45-48d79f8487c3_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (100, 35, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/bb35dc9c-d0fc-47a4-8d06-d18422d7f574_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (101, 36, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/59c5b111-ce7e-4cc0-8c28-8d4a762c2a1b_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (102, 36, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8a31530d-d89b-42c8-8e8d-0230f85c38ce_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (103, 36, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0b5e2e78-9b94-4336-821e-888c97a2dcff_7ae0120ec27dc3a7.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (104, 37, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/59c5b111-ce7e-4cc0-8c28-8d4a762c2a1b_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (105, 37, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8a31530d-d89b-42c8-8e8d-0230f85c38ce_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (106, 37, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0b5e2e78-9b94-4336-821e-888c97a2dcff_7ae0120ec27dc3a7.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (107, 38, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/61e8491d-c84a-4e98-8958-18cb5cdbd5ee_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (108, 38, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (109, 38, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0b5e2e78-9b94-4336-821e-888c97a2dcff_7ae0120ec27dc3a7.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (110, 39, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/61e8491d-c84a-4e98-8958-18cb5cdbd5ee_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (111, 39, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (112, 39, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0b5e2e78-9b94-4336-821e-888c97a2dcff_7ae0120ec27dc3a7.jpg', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (32, 28, '华为 HUAWEI Mate 30E Pro 翡冷翠 8+256', NULL, 225, 22, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30E Pro 翡冷翠 8+256 5G麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '【Mate40Pro稀缺爆品】麒麟9000芯片，稀缺货源限量抢购！猛戳》》》华为手机热销爆款，限量抢购', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (33, 28, '华为 HUAWEI Mate 30E Pro 翡冷翠 8+128', NULL, 225, 22, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/37cfc459-414b-49eb-884f-52e917eaa9b6_a83bf5250e14caf2.jpg', '华为 HUAWEI Mate 30E Pro 翡冷翠 8+128 5G麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '【Mate40Pro稀缺爆品】麒麟9000芯片，稀缺货源限量抢购！猛戳》》》华为手机热销爆款，限量抢购', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (34, 28, '华为 HUAWEI Mate 30E Pro 星河银 8+256', NULL, 225, 22, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30E Pro 星河银 8+256 5G麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '【Mate40Pro稀缺爆品】麒麟9000芯片，稀缺货源限量抢购！猛戳》》》华为手机热销爆款，限量抢购', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (35, 28, '华为 HUAWEI Mate 30E Pro 星河银 8+128', NULL, 225, 22, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30E Pro 星河银 8+128 5G麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '【Mate40Pro稀缺爆品】麒麟9000芯片，稀缺货源限量抢购！猛戳》》》华为手机热销爆款，限量抢购', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (36, 29, 'Apple iPhone XR (A2108)  红色 128G', NULL, 225, 24, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/59c5b111-ce7e-4cc0-8c28-8d4a762c2a1b_6a1b2703a9ed8737.jpg', 'Apple iPhone XR (A2108)  红色 128G   移动联通电信4G手机 双卡双待', '更多精彩活动请关注！点此抢购5G新品！点击抢购！', 4499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (37, 29, 'Apple iPhone XR (A2108)  红色 64G', NULL, 225, 24, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/59c5b111-ce7e-4cc0-8c28-8d4a762c2a1b_6a1b2703a9ed8737.jpg', 'Apple iPhone XR (A2108)  红色 64G  移动联通电信4G手机 双卡双待', '更多精彩活动请关注！点此抢购5G新品！点击抢购！', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (38, 29, 'Apple iPhone XR (A2108)  白色 128G', NULL, 225, 24, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', 'Apple iPhone XR (A2108)  白色 128G  移动联通电信4G手机 双卡双待', '更多精彩活动请关注！点此抢购5G新品！点击抢购！', 4499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (39, 29, 'Apple iPhone XR (A2108)  白色 64G', NULL, 225, 24, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', 'Apple iPhone XR (A2108)  白色 64G  移动联通电信4G手机 双卡双待', '更多精彩活动请关注！点此抢购5G新品！点击抢购！', 3999.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 79 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (63, 32, 35, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (64, 32, 36, '版本', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (65, 33, 35, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (66, 33, 36, '版本', '8+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (67, 34, 35, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (68, 34, 36, '版本', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (69, 35, 35, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (70, 35, 36, '版本', '8+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (71, 36, 35, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (72, 36, 36, '版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (73, 37, 35, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (74, 37, 36, '版本', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (75, 38, 35, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (76, 38, 36, '版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (77, 39, 35, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (78, 39, 36, '版本', '64G', NULL);
...
CREATE TABLE `pms_spu_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价' ROW_FORMAT = Compact;
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 88 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu图片' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (78, 28, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/09c80607-c5d4-4587-8a9c-fe61c509d989_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (79, 28, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/37cfc459-414b-49eb-884f-52e917eaa9b6_a83bf5250e14caf2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (80, 28, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0ef4cf36-5e97-4c65-8b45-48d79f8487c3_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (81, 28, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/bb35dc9c-d0fc-47a4-8d06-d18422d7f574_d511faab82abb34b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (82, 28, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/e39bbc12-385f-48ff-8d0a-7a2b6fea831f_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (83, 29, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/61e8491d-c84a-4e98-8958-18cb5cdbd5ee_23cd65077f12f7f5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (84, 29, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/59c5b111-ce7e-4cc0-8c28-8d4a762c2a1b_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (85, 29, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8a31530d-d89b-42c8-8e8d-0230f85c38ce_5b5e74d0978360a1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (86, 29, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/8af8a806-44ca-40fc-87df-b2e74ffe8826_749d8efdff062fb0.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (87, 29, NULL, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/0b5e2e78-9b94-4336-821e-888c97a2dcff_7ae0120ec27dc3a7.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (28, '华为 HUAWEI Mate 30E Pro', '华为 HUAWEI Mate 30E Pro', 225, 22, 0.2000, 1, '2021-03-22 13:07:21', '2021-03-22 13:35:13');
INSERT INTO `pms_spu_info` VALUES (29, 'Apple iPhone XR (A2108) ', 'Apple iPhone XR (A2108) ', 225, 24, 0.2000, 1, '2021-03-22 16:05:57', '2021-03-22 16:13:18');
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu信息介绍' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_spu_info_desc
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (28, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/7ba83e26-9b3c-464d-87b9-6fc637c6b015_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (29, 'https://gulimallzhyf.oss-cn-hangzhou.aliyuncs.com/2021-03-22/5187424a-f2a5-4645-87eb-8bf9be7a0ec3_f205d9c99a2b4b01.jpg');
